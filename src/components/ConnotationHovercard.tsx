...
// Optimized: Memoized to prevent re-renders when parent ResultsView updates (e.g. on resize or unrelated state changes).
// This is critical because there can be many hovercards on the screen.
